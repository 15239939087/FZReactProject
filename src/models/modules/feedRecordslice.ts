import {
   ...
   * Thunk
   */
  export const fetchFeedHistories = createAsyncThunk<any>('feedRecord/fetchFeedRecord', async _ => {
  ...
  export const selectTodayFeedCount =  (state: RootState) => state.feedRecord.todayFeedCount;
  ...
  export const selectFeedHistoryByCurrent = createSelector(
    [selectFeedHistoryIds, selectFeedEntities, (_state: RootState, day: number) => day],
    (ids, entities, day) => {
